    ...
    jQuery.extend({
        ...
        getHeight: function() {
            ...
            if (window.navigator.userAgent.indexOf("Firefox") > 0) {
                _t = window.document.documentElement;
                _height = _t.scrollHeight;
            } else {
        ...
        getWidth: function() {
            var _width, _t;
            if (window.navigator.userAgent.indexOf("Firefox") > 0) {
                _width = window.document.documentElement.scrollWidth;
            } else {
                if (window.addEventListener) {
                    _width = window.document.body.scrollWidth;
                } else if (window.attachEvent) {
